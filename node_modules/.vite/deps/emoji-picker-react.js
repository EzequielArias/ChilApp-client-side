...
function createSheet(name) {
  ...
  function create(styles2) {
    const scopedStyles = {};
    forIn(styles2, (scopeName, styles22) => {
      const scopeClassName = stableHash(sheet.name, scopeName);
      if (is.topLevelClass(scopeName, styles22)) {
        forIn(styles22, (property, value) => {
          iterateStyles(
            sheet,
            value,
            scopeClassName,
      ...
      iterateStyles(sheet, styles22, scopeClassName).forEach(
        (className) => {
...
function iterateStyles(sheet, styles2, scopeClassName, parentClassName) {
...
function handleChunks(sheet, styles2, property, scopeClassName) {
  const classes = /* @__PURE__ */ new Set();
  const chunkRows = [];
  forIn(styles2, (property2, value) => {
...
function handleMediaQuery(sheet, styles2, property, scopeClassName) {
  sheet.append(chunkSelector([scopeClassName], property) + " {");
  const output = iterateStyles(sheet, styles2, scopeClassName);
  sheet.append("}");
  return output;
}
...
function Button(props) {
  return (0, import_react.createElement)("button", Object.assign({
    ...
    className: cx("epr-btn", props.className)
  }), props.children);
}
function ClickableEmojiButton(_ref) {
  ...
  return (0, import_react.createElement)(Button, {
    className: cx(ClassNames.emoji, hidden && commonStyles.hidden, hiddenOnSearch && commonStyles.hiddenOnSearch, (_cx = {}, _cx[ClassNames.visible] = !hidden && !hiddenOnSearch, _cx[ClassNames.emojiHasVariations] = hasVariations && showVariations, _cx)),
...
function EmojiCategory(_ref) {
  ...
  return (0, import_react.createElement)("li", {
    className: cx(styles.category, hidden && commonStyles.hidden, hiddenOnSearch && commonStyles.hiddenOnSearch),
    "data-name": category,
...
function EmojiList() {
  ...
  return (0, import_react.createElement)("ul", {
    className: cx(styles$1.emojiList)
...
function Flex(_ref) {
  ...
  return (0, import_react.createElement)("div", {
    ...
    className: cx(styles$3.flex, className, styles$3[direction])
  }, children);
}
var styles$3 = stylesheet.create((_stylesheet$create = {
  flex: {
    display: "flex"
  }
...
function SkinTonePicker(_ref) {
  ...
  return (0, import_react.createElement)(Relative, {
    className: cx("epr-skin-tones", direction, (_cx = {}, _cx[ClassNames.open] = isOpen, _cx)),
    style: vertical ? {
    ...
    return (0, import_react.createElement)(Button, {
      ...
      className: cx("epr-tone-" + skinToneVariation, "epr-tone", (_cx2 = {}, _cx2[ClassNames.active] = active, _cx2)),
      tabIndex: isOpen ? 0 : -1,
      "aria-pressed": active,
...
function CategoryNavigation() {
  ...
  return (0, import_react.createElement)("div", {
    ...
    return (0, import_react.createElement)(Button, {
      ...
      className: cx("epr-cat-btn", "epr-icn-" + category, (_cx = {}, _cx[ClassNames.active] = isActiveCategory, _cx)),
      key: category,
      onClick: function onClick() {
...
function Search() {
  ...
  return (0, import_react.createElement)(Relative, {
    ...
    role: "status",
    className: cx("epr-status-search-results", "epr-status-visually-hidden"),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
...
function PickerRootElement(_ref2) {
  ...
  return (0, import_react.createElement)("aside", {
    className: cx(styles$6.main, styles$6.baseVariables, theme === Theme.DARK && styles$6.darkTheme, theme === Theme.AUTO && styles$6.autoThemeDark, (_cx = {}, _cx[ClassNames.searchActive] = searchModeActive, _cx), className),
    ref: PickerMainRef,
    style
  }, children);
}
